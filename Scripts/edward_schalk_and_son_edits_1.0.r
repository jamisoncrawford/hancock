...
url <- "https://raw.githubusercontent.com/jamisoncrawford/REIS/master/Manual%20Scrapes/schalk_and_son_manual_scrape_1.0.csv"
...
write_csv(dat, "schalk_and_son_manual_scrape_1.1.csv")
