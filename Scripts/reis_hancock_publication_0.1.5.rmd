...
county_shapes <- county_shapes[, c(5, 1:4, 6:19)]
```
...
```{r choropleth_workers_output, message=FALSE, warning=FALSE, echo=FALSE, fig.width=8.25, fig.height=7, cache=TRUE}
...
*Click on a county to see the number of workers there.*
