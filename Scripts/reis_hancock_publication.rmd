...
**Table 10.1: Net Earnings v. Contractor by Race**
...
**Table 10.2: Individual Net Earnings v. Contractor by Race**

```{r echo=FALSE, message=FALSE, fig.width=12, fig.height=8}
library(ggplot2)

ggplot(net[net$Race == "White", ], aes(x = Name, y = Net, color = Race)) +
  geom_jitter(alpha = 0.2, width = 0.175) +
  geom_jitter(data = net[net$Race != "White", ], width = 0.175, alpha = 0.9, aes(x = Name, y = Net, color = Race)) +
  xlab("Contractor") +
  scale_color_brewer(palette = "Set2") +
  theme_classic() +
  theme(legend.position = "bottom") +
