...
**Alternate visualizations help illustrate the distribution of hourly wages conditioned on race and contractor.** *Figure 8.2: Frequency of Hourly Wages Earned by Race & Contractor* depicts a stacked trellis histogram depicting hourly wage distributions by race and conditioned on contractor. Each bar represents a $1 increment in hourly rates.  

<br>

<center>

**Figure 8.2: Frequency of Hourly Wages Earned by Race & Contractor**
...
ggplot(net[net$Race == "White", ], aes(x = Name, y = Net, color = Race)) +
  geom_jitter(alpha = 0.3, width = 0.175) +
  geom_jitter(data = net[net$Race != "White", ], size = 2, width = 0.175, alpha = 0.9, aes(x = Name, y = Net, color = Race)) +
  xlab("Contractor") +
  scale_color_brewer(palette = "Set2") +
  theme_classic() +
  theme(legend.position = "bottom") +
